                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <p className="profile-rating mt-3 mb-5">
                         Ranking <span>2/10</span>
                        </p>
                        <p>Team</p>
                        <ul className="nav nav-tabs" role="tablist">
                            
                        <li className="nav-item">
                                   <a className="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Member 1</a>
                                    </li>
                                    <li className="nav-item">
                                       <a className="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Member 2</a>
                    ...
                    <div className="col-md-4">
                        <div className="profile-work">
                            <p>WORK LINK</p>
                                ...
                                <a href="https://www.youtube.com/channel/UCwfaAHy4zQUb2APNOGXUCCA" target="_thapa">Facebook</a> <br />
                    ...
                    <div className="row">
                        ...
                        {/* <div className="col-md-4">
                            <div className="profile-work">
                                ...
                                <a href="https://www.youtube.com/channel/UCwfaAHy4zQUb2APNOGXUCCA" target="_thapa">Instagram</a> <br />
                                <a href="https://www.youtube.com/channel/UCwfaAHy4zQUb2APNOGXUCCA" target="_thapa">Aayush chauhan</a> <br />
